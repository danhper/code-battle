...
ActiveRecord::Schema.define(version: 20131216120732) do
  ...
  create_table "guild_members_counts", force: true do |t|
    t.integer  "guild_id"
    t.datetime "datetime"
  ...
  add_index "guild_members_counts", ["guild_id"], name: "index_guild_members_counts_on_guild_id", using: :btree
