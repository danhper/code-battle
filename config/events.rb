...
WebsocketRails::EventMap.describe do
  ...
  subscribe :client_connected, to: BattleController, with_method: :handle_connection
  ...
  subscribe :client_disconnected, to: BattleController, with_method: :handle_disconnection
